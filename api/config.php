<?php
// api/config.php
// Database configuration for course access system

// Database connection parameters
$host = 'localhost'; // Update this to your database host
$dbname = 'trendtactics_academy'; // Update this to your database name
...
// Supabase configuration (if needed for additional functionality)
