-- ============================================================================
-- RESCUE VIBE CODING (Link Orphans & Fix Videos)
-- ============================================================================
-- 1. Connects "Orphaned" lessons (course_id IS NULL) to the Vibe Coding course.
-- 2. Assigns them to the correct Modules (1-8).
-- 3. Updates their Video URLs from the Master Backup.
-- ============================================================================
...
BEGIN
    ...
    -- 2. Get Module IDs (Create if missing would be safer, but assuming they exist from previous scripts)
...
-- VERIFICATION
SELECT l.title, c.title as course, l.video_url 
FROM lessons l
