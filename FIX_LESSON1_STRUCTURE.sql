-- FIX LESSON 1 CONTENT STRUCTURE
-- Reorganizes content: Learning Objectives first, then content, simulator at end
-- Updates video URL and fixes structure
...
BEGIN
    ...
    RAISE NOTICE 'Restructuring Lesson 1 content...';
    
    -- New properly structured content
...
<h2>Practice with Meta Ads Manager</h2>

<div class="practice-section" style="background: #f8f9fa; padding: 2rem; border-radius: 8px; margin: 2rem 0; border-left: 4px solid #1e3a8a;">
    <h3 style="margin-bottom: 1rem; color: #1e3a8a;">Hands-On Practice</h3>
    <p style="margin-bottom: 1.5rem; color: #4b5563;">To get hands-on experience with Meta Ads Manager, visit the platform directly and explore the interface. Practice navigating between campaigns, ad sets, and ads to familiarize yourself with the layout.</p>
    <a href="https://www.facebook.com/business/tools/ads-manager" target="_blank" 
       style="display: inline-block; background: #1e3a8a; color: white; padding: 0.75rem 1.5rem; border-radius: 6px; text-decoration: none; font-weight: 600;">
        Open Meta Ads Manager
    </a>
    <p style="margin-top: 1rem; font-size: 0.875rem; color: #6b7280;">Note: You will need a Facebook account. This is a safe practice environment - you will not spend money unless you actively create and publish campaigns.</p>
</div>
...
<p>The landscape of digital advertising is constantly evolving, with Meta regularly introducing new features, ad formats, and targeting capabilities. Staying current with these changes and understanding how to leverage them for your specific business goals is an ongoing process. However, the fundamental principles covered in this lesson - understanding the campaign structure, monitoring the right metrics, and making data-driven decisions - will serve you well regardless of how the platform evolves in the future.</p>
    ...
    -- Update lesson with new content and video URL
    UPDATE lessons
    SET 
        content = new_content,
    ...
    RAISE NOTICE 'Lesson 1 content restructured successfully';
...
SELECT 
    ...
    CASE WHEN l.content LIKE '%<h2>Learning Objectives</h2>%' THEN 'YES' ELSE 'NO' END as has_objectives
FROM lessons l
