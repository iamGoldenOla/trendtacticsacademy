-- Complete deployment script for Vibe Coding course
-- This script will clean up any existing data and insert the complete course

-- First, clean up any existing Vibe Coding course data
...
-- Now insert the complete Vibe Coding course
