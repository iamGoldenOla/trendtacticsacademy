            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <a href="https://trendtacticsdigital.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors text-sm">
                                    Digital Marketing Services
                                </a>
                            </li>
                            <li>
                                <a href="https://trendtacticsdigital.com/academy" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors text-sm">
                ...
                <div className="mt-12 pt-8 border-t border-gray-700">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-300 text-sm">
                            © {currentYear} Trendtactics Academy. All rights reserved.
                        </p>
