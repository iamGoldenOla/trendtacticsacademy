...
export const AIDashboard = ({ userId, currentCourse, currentLesson }) => {
    ...
    const renderTabContent = () => {
        switch (activeTab) {
            case 'chat':
                return (<AITutorChat courseId={currentCourse} lessonId={currentLesson} topic={undefined} isOpen={true} onClose={() => { }}/>);
