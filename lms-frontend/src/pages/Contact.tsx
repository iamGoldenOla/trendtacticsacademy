...
const Contact: React.FC = () => {
  ...
  const [copied, setCopied] = useState<{ phone: boolean; address: boolean; email: boolean }>({ phone: false, address: false, email: false });
  ...
  const handleCopy = (type: 'phone' | 'address' | 'email', value: string) => {
  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-brand-navy flex flex-col items-center justify-center py-8 px-2">
      {/* HERO SECTION */}
      ...
      <div className="flex flex-col md:flex-row-reverse md:justify-center md:items-stretch gap-6 w-full max-w-5xl mb-8">
        ...
        <section
          className="lesson-3d-card duration bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6 sm:p-8 w-full md:w-[340px] flex-shrink-0 flex flex-col justify-center mx-auto hover:shadow-2xl transition-shadow"
          ...
          <div className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="ml-1 px-2 py-1 rounded bg-cyan-100 dark:bg-cyan-900 text-brand-navy dark:text-brand-cyan text-xs font-semibold hover:bg-cyan-200 dark:hover:bg-cyan-800 transition-colors"
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  type="button"
                  className="ml-1 px-2 py-1 rounded bg-cyan-100 dark:bg-cyan-900 text-brand-navy dark:text-brand-cyan text-xs font-semibold hover:bg-cyan-200 dark:hover:bg-cyan-800 transition-colors"
                  onClick={() => handleCopy('email', 'support@trendtactics.com')}
        ...
        <section
          className="lesson-3d-card duration bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-6 sm:p-10 w-full md:w-1/2 flex-shrink-0 hover:shadow-2xl transition-shadow"
        ...
        >
          ...
          <form className="space-y-4" aria-label="Contact form" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                name="name"
                type="text"
                className={`input-field transition-shadow duration-200 focus:shadow-lg ${errors.name ? 'border-red-500' : ''}`}
          ...
          <div>
              ...
              <input
                ...
                name="email"
                type="email"
                className={`input-field transition-shadow duration-200 focus:shadow-lg ${errors.email ? 'border-red-500' : ''}`}
          ...
          <div>
              ...
              <textarea
                id="message"
                name="message"
                className={`input-field transition-shadow duration-200 focus:shadow-lg ${errors.message ? 'border-red-500' : ''}`}
                rows={4}
      ...
      <section className="w-full max-w-2xl mb-8" aria-label="Location map">
        ...
        <div className="text-center mt-2">
          <a
            href="https://www.google.com/maps/dir/?api=1&destination=12+Allen+Avenue,+Ikeja,+Lagos,+Nigeria"
            target="_blank"
            rel="noopener noreferrer"
            className="text-brand-cyan underline text-sm hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors"
          >
            Get Directions
          </a>
        </div>
