-- SIMPLIFIED LESSON 1 FIX - Direct Link Instead of Iframe
-- Removes iframe (not clickable) and uses direct link to simulator
-- This is more reliable and works better
...
BEGIN
    ...
    RAISE NOTICE 'Updating Lesson 1 with direct simulator link...';
    
    -- Content with direct link to simulator (opens in new tab)
...
<p>The landscape of digital advertising is constantly evolving, with Meta regularly introducing new features, ad formats, and targeting capabilities. However, the fundamental principles covered in this lesson will serve you well regardless of how the platform evolves in the future.</p>
    ...
    RAISE NOTICE 'Lesson 1 updated with direct simulator link!';
